...
/***/ function(module, exports, __webpack_require__) {
	...
	_reactDom2.default.render(_react2.default.createElement(_App2.default, { itemsPerPage: 16 }), document.getElementById('app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	// having to use {zenscroll} is weird, should be plain: zenscroll
	...
	var App = function (_React$Component) {
		...
		_createClass(App, [{
			key: 'nextPage',
			value: function nextPage(next) {
				this.setState({ pageIndex: this.state.pageIndex + (next ? 1 : -1) });
				//scrollTo(0, 0);
				_zenscroll.zenscroll.toY(0);
			...
			value: function render() {
				...
				var items = [];
				for (var i = Math.max(0, this.props.itemsPerPage * this.state.pageIndex), n = Math.min(data.length, this.props.itemsPerPage * (this.state.pageIndex + 1)); i < n; i++) {
					items.push(_react2.default.createElement(Item, { key: i % this.props.itemsPerPage, data: data[i] }));
				}
				return _react2.default.createElement(
					'div',
					{ id: 'questionary', className: 'questionary' },
					items,
			...
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(Option, { size: 'large', color: 'green' }),
						_react2.default.createElement(Option, { size: 'medium', color: 'green' }),
						_react2.default.createElement(Option, { size: 'small', color: 'green' }),
						_react2.default.createElement(Option, { size: 'small', color: 'neutral' }),
						_react2.default.createElement(Option, { size: 'small', color: 'purple' }),
						_react2.default.createElement(Option, { size: 'medium', color: 'purple' }),
						_react2.default.createElement(Option, { size: 'large', color: 'purple' })
					)
				);
			}
		}]);
	...
	var Option = function Option(props) {
		return _react2.default.createElement('div', { className: 'option ' + props.size + ' ' + props.color });
	};
